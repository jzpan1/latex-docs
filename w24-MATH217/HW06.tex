...
\begin{questions}
\question Let $V$ be a vector space, and let ($\vec v_1, . . . , \vec v_n$) be a list of vectors in $V$. Deﬁne the function $T : \reals^n \rightarrow V$ by
    ...
    \begin{parts}
        \part Find the $\mathcal{E}$-matrix $[T]_\mathcal{E}$ of $T$, where 
            ...
            \begin{solution}
                ...
                \begin{align*}
                    \left[T\right]_\mathcal E \left(\begin{bmatrix}
                        1 \\ 0 \\ 0 \\ 0
                    \end{bmatrix}\right) = \left[\begin{bmatrix*} 1 & 0 \\ 0 & 0 \end{bmatrix*}\right]_\mathcal E = \begin{bmatrix} 1 \\ 0 \\ 0 \\ 0 \end{bmatrix}
                \end{align*}
            \end{solution}
