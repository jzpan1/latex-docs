...
\begin{solution}
  ...
  \par Since $98 = 14 * 7$, we know there are either 13 or 14 integers to choose in each ``remainder hole.'' In the case of 14 integers, pair these 14 integers into 7 ``difference holes,'' each with two consecutive integers with a difference of 7 between them (e.g. 4 and 11). Then, using the 8 pigeons we know will enter the ``remainder hole,'' we know one of these ``difference holes'' must contain 2 pigeons. 
  \par In the case of 13 integers, one 
\end{solution}
