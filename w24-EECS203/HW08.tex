...
\begin{solution}
    \begin{qparts}
        ...
        \item This is a tree because it contains no cycles. Additionally, since it does not contain any cycles, it does not contain odd cycles, and so is not bipartite.
        \item This is a tree because it contains no cycles. Additionally, since it does not contain any cycles, it does not contain odd cycles, and so is not bipartite.
    \end{qparts}
\end{solution}
