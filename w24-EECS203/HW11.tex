...
\begin{solution}
    \begin{qparts}
        ...
        \item We know that there exists $k, c_1, c_2 \in \mathbb R$ such that for all $x \in \mathbb R \geq k$, \[c_1 4^x \leq g(x) \leq c_2\frac{x!}{2^x}\]
        So then taking the negative, 
            \[-c_1 4^x \geq -g(x) \geq -c_2\frac{x!}{2^x}\]
        So we cannot infer anything about $4^x$ being a lower bound of 
    \end{qparts}
\end{solution}
