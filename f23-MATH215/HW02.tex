...
\question Do Exercises 23-30 of section 12.6 of Stewart’s \textit{Multivariable Calculus}.
	...
	\begin{questions}
		...
		\question \boxed{II} -- can be rearranged to $y^2+1=x^2+z^2 \Rightarrow$ circles around y-axis which increase radius starting from 1 at the origin. Approaches a linear increase in radius, but not quite because of the $+1$ term. Symmetrical across $xz$ plane because $y$ is squared.
		\question \boxed{III} -- Same as 25, except the $-1$ causes no solutions until $y=1$. 
