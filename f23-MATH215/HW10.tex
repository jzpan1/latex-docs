...
\question Please do Exercises 13-18 of §16.6 in Stewart’s \textit{Multivariable Calculus}.
    \begin{solution}
        \begin{questions}
            ...
            \question \boxed{VI} -- A cylinder because $x$ and $z$ are not related to $y$ at all. Curves parallel to $y$ axis have $u$ constant, while those parallel to $x$ have $v$ constant.
