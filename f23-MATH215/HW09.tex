...
\question Do Exercises 11, 31, and 32 of §16.3 in $Stewart's\ Multivariable\ Calculus$. \\
	...
	\begin{questions}
		...
		\question This vector field is not conservative because any counterclockwise path will have positive work, whereas clockwise paths will have negative work. Thus, this field is not the gradient of a function. You could also verify this by drawing level curves perpendicular to the vectors, which would all pass through the origin. However, since they are all increasing counterclockwise, this would be impossible for a function to have.
		\question 
	\end{questions}
