...
%6
\question  The small but edgy city of Dreieck is modeled by the region $D = {(x, y) : 5 |x| \leq y \leq 5}$, where x and y are measured in km. The population density in people per km$^2$ is given by $\rho(x, y) = 10^{3-y}$. Find the
total population of the city. (This should preferably be an integer.)
